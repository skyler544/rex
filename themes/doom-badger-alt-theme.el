;;; doom-badger-alt-theme.el --- inspired by cann's Badger colorscheme -*- lexical-binding: t; no-byte-compile: t; -*-
;;
...
(defgroup doom-badger-alt-theme nil
  "Options for the `doom-badger-alt' theme."
  :group 'doom-themes)

(defcustom doom-badger-alt-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'doom-badger-alt-theme
  :type 'boolean)

(defcustom doom-badger-alt-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'doom-badger-alt-theme
  :type 'boolean)

(defcustom doom-badger-alt-comment-bg doom-badger-alt-brighter-comments
  "If non-nil, comments will have a subtle, darker background. Enhancing their
legibility."
  :group 'doom-badger-alt-theme
  :type 'boolean)

(defcustom doom-badger-alt-padded-modeline doom-themes-padded-modeline
...
(def-doom-theme doom-badger-alt
  "A dark theme inspired by original badger theme"

  ;; name        default   256       16
  ((bg         '("#212121" nil       nil            )) ;; badger-bg
   ...
   (magenta    '("#a9a1e1" "#BF93C3" "magenta"      )) ;; badger-violet
   (violet     '("#a9a1e1" "#BF93C3" "magenta"      )) ;; badger-violet
   ...
   (selection      dark-blue)
   (builtin        salmon)
   (comments       (doom-lighten base4 0.3))
   (doc-comments   (doom-lighten base4 0.3))
   (constants      (doom-lighten (doom-blend dull-red red 0.5) 0.1))
   (functions      green)
   (keywords       blue)
   (methods        cyan)
   (operators      sand)
   ...
   (-modeline-bright doom-badger-alt-brighter-modeline)
   (-modeline-pad
    (when doom-badger-alt-padded-modeline
      (if (integerp doom-badger-alt-padded-modeline) doom-badger-alt-padded-modeline 4)))

   (modeline-fg     fg)
   (modeline-fg-alt (doom-lighten base5 0.2))
  ...
  (((font-lock-comment-face &override)
   ((line-number &override) :foreground (doom-lighten base4 0.3))
   ((line-number-current-line &override) :foreground fg)
    :background (if doom-badger-alt-comment-bg (doom-lighten bg 0.05)))
   (mode-line
...
;;; doom-badger-alt-theme.el ends here
