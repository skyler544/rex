;;; doom-ayu-mirage-alt-theme.el --- inspired by Ayu Mirage -*- lexical-binding: t; no-byte-compile: t; -*-
;;
...
(defgroup doom-ayu-mirage-alt-theme nil
  "Options for the `doom-ayu-mirage-alt' theme."
  :group 'doom-themes)

(defcustom doom-ayu-mirage-alt-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'doom-ayu-mirage-alt-theme
  :type 'boolean)

(defcustom doom-ayu-mirage-alt-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'doom-ayu-mirage-alt-theme
  :type 'boolean)

(defcustom doom-ayu-mirage-alt-comment-bg doom-ayu-mirage-alt-brighter-comments
  "If non-nil, comments will have a subtle, darker background. Enhancing their
legibility."
  :group 'doom-ayu-mirage-alt-theme
  :type 'boolean)

(defcustom doom-ayu-mirage-alt-padded-modeline doom-themes-padded-modeline
...
(def-doom-theme doom-ayu-mirage-alt
  ...
  (
   ...
   (syntax-entity   '("#5caad1" "blue"    "blue"   ))
   ...
   (selection      nil)
   (builtin        nil)
   (comments       (doom-lighten syntax-comment 0.25))
   (doc-comments   (doom-lighten syntax-comment 0.25))
   ...
   ;; custom categories
   (hidden     (car bg))
   (-modeline-bright doom-ayu-mirage-alt-brighter-modeline)
   (-modeline-pad
    (when doom-ayu-mirage-alt-padded-modeline
      (if (integerp doom-ayu-mirage-alt-padded-modeline) doom-ayu-mirage-alt-padded-modeline 4)))
  ...
  (((line-number &override) :foreground syntax-comment)
   ...
   (font-lock-comment-face
    :foreground comments
    :background (if doom-ayu-mirage-alt-comment-bg (doom-lighten bg 0.05)))
   (font-lock-doc-face
...
;;; doom-ayu-mirage-alt-theme.el ends here
