;;; doom-monokai-machine-alt-theme.el --- port of Monokai Classic -*- lexical-binding: t; no-byte-compile: t; -*-
;;
...
(defgroup doom-monokai-machine-alt-theme nil
  "Options for doom-molokai."
  :group 'doom-themes)

(defcustom doom-monokai-machine-alt-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'doom-monokai-machine-alt-theme
  :type 'boolean)

(defcustom doom-monokai-machine-alt-comment-bg doom-monokai-machine-alt-brighter-comments
  "If non-nil, comments will have a subtle, darker background.
Enhancing their legibility."
  :group 'doom-monokai-machine-alt-theme
  :type 'boolean)

(defcustom doom-monokai-machine-alt-padded-modeline doom-themes-padded-modeline
...
(def-doom-theme doom-monokai-machine-alt
  ...
  ((bg         '("#212a30" nil       nil            ))
   ...
   (green      '("#AFD8AF" "#AFD8AF" "green"        ))
   (cyan       '("#5caad1" "#5caad1" "brightcyan"   ))
   (yellow     '("#ffcc66" "#ffcc66" "yellow"   ))
   (blue-2     '("#6CA0A3"))
   (violet     '("#baa0f8" "#9370db" "magenta"      ))
   (magenta     (doom-blend violet cyan 0.3))
   (blue        (doom-lighten blue-2 0.2))
   ...
   (operators      red)
   (type           cyan)
   (strings        (doom-blend yellow blue 0.1))
   (variables      fg)
   (numbers        violet)
   (region         (doom-darken (doom-blend cyan base4 0.1) 0.1))
   (error          red)
   (warning        orange)
   (success        green)
   (vc-modified    orange)
   ...
   (-modeline-pad
    (when doom-monokai-machine-alt-padded-modeline
      (if (integerp doom-monokai-machine-alt-padded-modeline) doom-monokai-machine-alt-padded-modeline 4)))
  ...
  ((cursor                                       :background fg)
   ...
   ;; current line
   (hl-line                                      :background (doom-darken (doom-blend cyan base3 0.1) 0.3))
   ;; line-numbers
   ((line-number &override)                      :foreground (doom-lighten base4 0.1) :distant-foreground nil)
   ((line-number-current-line &override)         :foreground (doom-lighten base7 0.1) :distant-foreground nil)
   ;; mode-line
   (mode-line                                    :background base3 :foreground fg
                                                 :box (if -modeline-pad `(:line-width ,-modeline-pad :color red)))
   (mode-line-inactive                           :background base2 :foreground fg-alt
                                                 :box (if -modeline-pad `(:line-width ,-modeline-pad :color red)))
...
;;; doom-monokai-machine-alt-theme.el ends here
