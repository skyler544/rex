;;; doom-zenburn-alt-theme.el --- port of the popular Zenburn theme -*- lexical-binding: t; no-byte-compile: t; -*-
;;
...
(defgroup doom-zenburn-alt-theme nil
  "Options for the `doom-zenburn-alt' theme."
  :group 'doom-themes)

(defcustom doom-zenburn-alt-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'doom-zenburn-alt-theme
  :type 'boolean)

(defcustom doom-zenburn-alt-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'doom-zenburn-alt-theme
  :type 'boolean)

(defcustom doom-zenburn-alt-comment-bg doom-zenburn-alt-brighter-comments
  "If non-nil, comments will have a subtle, darker background.
Enhances their legibility."
  :group 'doom-zenburn-alt-theme
  :type 'boolean)

(defcustom doom-zenburn-alt-padded-modeline doom-themes-padded-modeline
...
(def-doom-theme doom-zenburn-alt
  "An implementation of the popular Zenburn theme."

  ;; name        default   256       16
  ((bg         '("#323232" nil       nil            )) ;; zenburn-bg
   (bg-alt     '("#2f2f2f" nil       nil            )) ;; zenburn-bg-05
   ...
   (-modeline-bright doom-zenburn-alt-brighter-modeline)
   (-modeline-pad
    (when doom-zenburn-alt-padded-modeline
      (if (integerp doom-zenburn-alt-padded-modeline) doom-zenburn-alt-padded-modeline 4)))
  ...
  ((cursor :background green+2)
   ...
   ((font-lock-comment-face &override)
    :background (if doom-zenburn-alt-comment-bg (doom-lighten bg 0.05)))
...
;;; doom-zenburn-alt-theme.el ends here
