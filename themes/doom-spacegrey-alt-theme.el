;;; doom-spacegrey-alt-theme.el --- I'm sure you've heard of it -*- lexical-binding: t; no-byte-compile: t; -*-
;;
...
(defgroup doom-spacegrey-alt-theme nil
  "Options for the `doom-spacegrey-alt' theme."
  :group 'doom-themes)

(defcustom doom-spacegrey-alt-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'doom-spacegrey-alt-theme
  :type 'boolean)

(defcustom doom-spacegrey-alt-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'doom-spacegrey-alt-theme
  :type 'boolean)

(defcustom doom-spacegrey-alt-comment-bg doom-spacegrey-alt-brighter-comments
  "If non-nil, comments will have a subtle, darker background. Enhancing their
legibility."
  :group 'doom-spacegrey-alt-theme
  :type 'boolean)

(defcustom doom-spacegrey-alt-padded-modeline doom-themes-padded-modeline
...
(def-doom-theme doom-spacegrey-alt
  ...
  ((bg         '("#2b303b" nil       nil            ))
   ...
   (cyan       '("#36c9d0" "#46D9FF" "brightcyan"   ))
   (dark-cyan  '("#5699AF" "#5699AF" "cyan"         ))
   (dark-blue  '("#2257A0" "#2257A0" "blue"         ))
   (blue       (doom-lighten (doom-blend dark-blue dark-cyan 0.4) 0.2))
   (violet     '("#b48ead" "#b48ead" "brightmagenta"))
   (teal       '("#4db5bd" "#44b9b1" "brightgreen"  ))
   (yellow     '("#ECBE7B" "#ECBE7B" "yellow"       ))
   (magenta    (doom-lighten (doom-blend dark-blue red 0.2) 0.2))

   ;; face categories -- required for all themes
   (highlight      orange)
   (vertical-bar   (doom-darken bg 0.25))
   (selection      (doom-darken (doom-blend bg base4 0.2) 0.1))
   (builtin        orange)
   (comments       (doom-lighten base5 0.2))
   (doc-comments   (doom-lighten base5 0.2))
   (constants      orange)
   (functions      (doom-blend teal yellow 0.5))
   (keywords       violet)
   (methods        blue)
   (operators      fg)
   (type           yellow)
   ...
   (-modeline-bright doom-spacegrey-alt-brighter-modeline)
   (-modeline-pad
    (when doom-spacegrey-alt-padded-modeline
      (if (integerp doom-spacegrey-alt-padded-modeline) doom-spacegrey-alt-padded-modeline 4)))
  ...
  (((font-lock-comment-face &override)
    :background (if doom-spacegrey-alt-comment-bg (doom-lighten bg 0.05)))
...
;;; doom-spacegrey-alt-theme.el ends here
